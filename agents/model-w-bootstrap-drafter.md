...
- **Strict Frontmatter**: Every skill must start with correct YAML frontmatter containing `name`, `description`, `license: Proprietary`, and `metadata.author: with-madrid.com`.
