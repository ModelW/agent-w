...
This skill orchestrates a three-phase bootstrapping process to create project-specific management skills. It delegates the work to specialized sub-agents to ensure thoroughness and accuracy.
...
### Phase 1: Exploration
Invoke the `model-w-bootstrap-explorer` agent to analyze the project's architecture, dependency managers, task management, and Model W versioning.
...
Once Phase 3 is complete, the bootstrap process is finished. Remind the user to restart or reload their agent session (e.g., `/skills reload`) to discover the new skills.
